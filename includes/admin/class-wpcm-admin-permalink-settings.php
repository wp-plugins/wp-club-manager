...
class WPCM_Admin_Permalink_Settings {
	...
	public function __construct() {
		$this->slugs = apply_filters( 'wpclubmanager_permalink_slugs', array(
			array( 'club', __( 'Clubs', 'wpclubmanager' ) ),
			array( 'player', __( 'Players', 'wpclubmanager' ) ),
			array( 'staff', __( 'Staff', 'wpclubmanager' ) ),
			array( 'match', __( 'Matches', 'wpclubmanager' ) ),
		) );
	...
	public function settings_init() {
		...
		add_settings_section( 'wpclubmanager-permalink', __( 'WP Club Manager Settings', 'wpclubmanager' ), array( $this, 'settings' ), 'permalink' );
	...
	public function settings() {
		echo wpautop( __( 'These settings control the permalinks used for WP Club Manager. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'wpclubmanager' ) );
	}
