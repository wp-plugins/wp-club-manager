...
class WPCM_Meta_Box_Player_Stats {
	...
	public static function output( $post ) {
		...
		if( is_array( $teams ) ) { ?>
			...
			<p><?php _e('Choose a team and season to edit the manual stats.', 'wpclubmanager'); ?></p>
			...
			foreach( $teams as $team ) {
				...
				<div class="wpcm-profile-stats-block">
					...
					<ul class="stats-tabs-<?php echo $rand; ?> stats-tabs-multi">
						...
						<li class="tabs-multi"><a href="#wpcm_team-0_season-0-<?php echo $rand; ?>"><?php printf( __( 'All %s', 'wpclubmanager' ), __( 'Seasons', 'wpclubmanager' ) ); ?></a></li>
